        ...
        <div class="row">
            <div class="col-md-6 offset-md-6">
                <form action="appointment.php" method="post" id="appointment_form" class="form-horizontal appointment_form">
                    ...
                    <?php 
                    $Parrof_princ_text_Content = "Rserva tu Cita";
                    ?>
                    ...
                    <?php
                    // boton de reserva tu cita
                    $ButonReplic_TS_button = "Reserva tu cita";
                    ?>
                    <!-- SUBMIT BUTTON -->

                    <button id="app_submit" class="default_btn" type="submit">
                        <?php echo"$ButonReplic_TS_button";?>
                    </button>
                </form>
            </div>
        </div>
        ...
        <div id="reviews-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-md-block">
                        <h3><?php  echo "$Open_infor_temFlasqurefisufgdugdownvd_rebifo";?></h3>
                        <p>
                            Somos la mejor peluquería del Mundo, te queremos bien !!
                            <br>
                            Acá te puedes sentir muy cómodo.
                ...
                <?php
                $Open_infor_temFlasqurefisufgdugdownvd_rebifo = "Te ofrecemos la mejor experiencia";
                ?>
                <!-- REVIEW 2 -->
                <div class="carousel-item">
                    <img class="d-block w-100" src="Design/images/barbershop_image_1.jpg" alt="First slide" style="visibility: hidden;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 sm-padding">
                ...
                $COlustelew_reci = "hola@configuroweb.com";
                ?>
            </div>
            <div class="col-lg-6 sm-padding">
                <div class="contact-form">
                    <div id="contact_ajax_form" class="contactForm">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <button id="contact_send" class="default_btn"><?php echo "$info";?></button>
                            </div>
                        </div>
