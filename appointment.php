	...
	<div class="container">
		...
		<form method="post" id="appointment_form" action="appointment.php">
			...
			<div class="select_services_div tab_reservation" id="services_tab">
				...
				<?php $Oulestlis = "¡Por favor, seleccione al menos un servicio!";
				echo "$Oulestlis";
				?>
				</div>
				...
				<div class="text_header">
					<span>
					<?php 
					echo "1. Escoge el servicio que requieres:";
					?>
					</span>
				</div>
			...
			<div class="select_date_time_div tab_reservation" id="calendar_tab">
				...
				<div class="text_header">
					<span>
					<?php echo "$text_Houper_neW";?>
					</span>
				</div>
				<?php 
				$text_Houper_neW = " 3.Eleccion de fecha y hora:";
				?>
